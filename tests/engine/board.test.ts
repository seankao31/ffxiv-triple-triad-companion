...
describe("same rule", () => {
  ...
  test("captures when two or more adjacent pairs have equal touching values", () => {
    ...
    const state = createInitialState(
      ...
      [opCard1, opCard2, filler, filler, filler],
      Owner.Player,
      { plus: false, same: true, reverse: false, fallenAce: false, ascension: false, descension: false, order: false, chaos: false },
    );
...
describe("plus rule", () => {
  ...
  test("captures when two or more adjacent pairs have equal sums", () => {
    ...
    const state = createInitialState(
      ...
      [opCard1, opCard2, filler, filler, filler],
      Owner.Player,
      { plus: true, same: false, reverse: false, fallenAce: false, ascension: false, descension: false, order: false, chaos: false },
    );
...
describe("full game", () => {
  test("plays a complete 9-turn game with correct scoring", () => {
    ...
    const state = createInitialState([p, p, p, p, p], [o, o, o, o, o], Owner.Player, { plus: true, same: false, reverse: false, fallenAce: false, ascension: false, descension: false, order: false, chaos: false });
...
describe("getScore", () => {
  test("counts cards on board and in hand for each player", () => {
    ...
    const state: GameState = {
      ...
      rules: { plus: false, same: false, reverse: false, fallenAce: false, ascension: false, descension: false, order: false, chaos: false },
      forcedCardId: null,
    };
...
describe("Reverse rule", () => {
  it("captures opponent card with strictly lower attacking value", () => {
    ...
    // 3 < 5 → should capture.
    const rules: RuleSet = { plus: false, same: false, reverse: true, fallenAce: false, ascension: false, descension: false, order: false, chaos: false };
...
describe("Fallen Ace rule", () => {
  it("A (10) still captures 1 under Fallen Ace (basic rule unchanged)", () => {
    const rules: RuleSet = { plus: false, same: false, reverse: false, fallenAce: true, ascension: false, descension: false, order: false, chaos: false };
  ...
  it("A (10) captures 1 under Reverse + Fallen Ace", () => {
    const rules: RuleSet = { plus: false, same: false, reverse: true, fallenAce: true, ascension: false, descension: false, order: false, chaos: false };
    const pCards = [createCard(10, 1, 1, 1), createCard(1,1,1,1), createCard(1,1,1,1), createCard(1,1,1,1), createCard(1,1,1,1)];
    const oCards = [createCard(1, 1, 1, 1), createCard(1,1,1,1), createCard(1,1,1,1), createCard(1,1,1,1), createCard(1,1,1,1)];
...
describe("Ascension rule", () => {
  const rules: RuleSet = { plus: false, same: false, reverse: false, fallenAce: false, ascension: true, descension: false, order: false, chaos: false };
...
describe("Descension rule", () => {
  const rules: RuleSet = { plus: false, same: false, reverse: false, fallenAce: false, ascension: false, descension: true, order: false, chaos: false };
...
describe("Order rule", () => {
  const orderRules: RuleSet = { plus: false, same: false, reverse: false, fallenAce: false, ascension: false, descension: false, order: true, chaos: false };
